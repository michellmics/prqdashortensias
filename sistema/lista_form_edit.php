                    ...
                    <div class="form-group has-warning">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-4">
                                ...
                                <input id="documento" name="documento" value="<? echo $siteAdmin->ARRAY_LISTAINFO["LIS_DCDOCUMENTO"]; ?>" style="text-transform: uppercase;" type="text" class="form-control" placeholder="RG OU CPF" minlength="8" maxlength="14" oninput="this.value = this.value.replace(/[^A-Za-z0-9-]/g, '')" required />
                            </div>
                        </div>
