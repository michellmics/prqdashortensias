                  ...
                  <table class="table table-hover">
                    ...
                    <?php foreach ($dadosPagina as $log): ?>
                      <tr>
                        ...
                        <td style="text-transform: uppercase; font-size: 10px; vertical-align: middle; color:#993399; ?>"><?= htmlspecialchars(strlen($log['LOG_DCAPARTAMENTO']) > 25 ? substr($log['LOG_DCAPARTAMENTO'], 0, 12) . '...' : $log['LOG_DCAPARTAMENTO']) ?></td> 
                        <td style="text-transform: uppercase; font-size: 10px; vertical-align: middle; color:#993399; ?>"><?= htmlspecialchars(strlen($log['LOG_DCMSG']) > 100 ? substr($log['LOG_DCMSG'], 0, 100) . '...' : $log['LOG_DCMSG']) ?></td> 
