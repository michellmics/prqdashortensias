 ...
 .btn-primary {
  ...
  .btn-warning:hover {
	...
	<div class="box-body table-responsive no-padding">
            ...
            <td style="text-transform: uppercase; font-size: 15px; vertical-align: middle;"><a href="javascript:void(0);" onclick="event.stopPropagation(); confirmDelete(<?= $morador['USU_IDUSUARIO']; ?>)"><i class="fa fa-edit"></i></span></a></td>      
                      </tr>
                    <?php endforeach; ?>   
                    </tr>
                  </table>
